...
def _main():
    ...
    from tinksync.main import cli_create, cli_get_accounts, cli_get_transactions, cli_set_account_nickname, cli_sync
    ...
    parser.add_argument("--go", action="store_true", help="Start reconciliation")
